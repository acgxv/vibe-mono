...
Sources: `README.md`, `Cargo.toml`, `package.json`, `tsconfig.json`, `apps/name_placeholder/Cargo.toml`, `apps/name_placeholder/README.md`, `scripts/list-template-markers.ts`.

## Start Here

Prerequisites for the common local path:

- Global stable Rust with Cargo and Clippy; this template intentionally does not select a local rustup toolchain.
